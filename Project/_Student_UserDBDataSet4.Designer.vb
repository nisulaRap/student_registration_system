...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("_Student_UserDBDataSet4"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class _Student_UserDBDataSet4
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As _Student_UserDBDataSet4 = CType(MyBase.Clone,_Student_UserDBDataSet4)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "_Student_UserDBDataSet4"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/_Student_UserDBDataSet4.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As _Student_UserDBDataSet4 = New _Student_UserDBDataSet4()
    ...
    Partial Public Class StudentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddStudentRow(ByVal Stu_ID As String, ByVal Name_with_Initials As String, ByVal Full_Name As String, ByVal NIC As String, ByVal DOB As String, ByVal Gender As String, ByVal Address As String, ByVal Email As String, ByVal Telephone As String, ByVal Course_ID As String, ByVal Course_Name As String) As StudentRow
            Dim rowStudentRow As StudentRow = CType(Me.NewRow,StudentRow)
            Dim columnValuesArray() As Object = New Object() {Stu_ID, Name_with_Initials, Full_Name, NIC, DOB, Gender, Address, Email, Telephone, Course_ID, Course_Name}
...
Namespace _Student_UserDBDataSet4TableAdapters
    ...
    Partial Public Class StudentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Stu_ID], [Name with Initials], [Full Name], [NIC], "& _ 
                "[DOB], [Gender], [Address], [Email], [Telephone], [Course_ID], [Course Name]) VA"& _ 
                "LUES (@Stu_ID, @Name_with_Initials, @Full_Name, @NIC, @DOB, @Gender, @Address, @"& _ 
                "Email, @Telephone, @Course_ID, @Course_Name)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Stu_ID, [Name with Initials], [Full Name], NIC, DOB, Gender, Address, Emai"& _ 
                "l, Telephone, Course_ID, [Course Name] FROM dbo.Student"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        Stu_ID, [Name with Initials], [Full Name], NIC, DOB, Gender, Addres"& _ 
                "s, Email, Telephone, Course_ID, [Course Name]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Student"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE   "& _ 
                "     (Stu_ID = @Param1)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Param1", Global.System.Data.SqlDbType.NVarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "Stu_ID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(2) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT        Stu_ID, [Name with Initials], [Full Name], NIC, DOB, Gender, Addres"& _ 
                "s, Email, Telephone, Course_ID, [Course Name]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Student"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE   "& _ 
                "     (Stu_ID = @Param1)"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Param1", Global.System.Data.SqlDbType.NVarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "Stu_ID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As _Student_UserDBDataSet4.StudentDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As _Student_UserDBDataSet4.StudentDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As _Student_UserDBDataSet4.StudentDataTable = New _Student_UserDBDataSet4.StudentDataTable()
        ...
        Public Overloads Overridable Function Search(ByVal dataTable As _Student_UserDBDataSet4.StudentDataTable, ByVal Param1 As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function Search1(ByVal dataTable As _Student_UserDBDataSet4.StudentDataTable, ByVal Param1 As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As _Student_UserDBDataSet4.StudentDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As _Student_UserDBDataSet4) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Stu_ID As String, ByVal Name_with_Initials As String, ByVal Full_Name As String, ByVal NIC As String, ByVal DOB As String, ByVal Gender As String, ByVal Address As String, ByVal Email As String, ByVal Telephone As String, ByVal Course_ID As String, ByVal Course_Name As String) As Integer
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As _Student_UserDBDataSet4, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As _Student_UserDBDataSet4, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._studentTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As _Student_UserDBDataSet4, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._studentTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As _Student_UserDBDataSet4) As Integer
